            ...
            <div className="bg-slate-800/50 backdrop-blur rounded-2xl p-8 border border-slate-700/50">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm">Never miss a deadline</p>
                </div>
              </div>
              <div className="space-y-3">
                {[
                  ...
                  <div key={i} className={`p-4 rounded-lg ${alert.urgent ? 'bg-red-500/10 border border-red-500/20' : 'bg-slate-700/50'}`}>
                    <div className="flex justify-between items-center">
                      <span className="text-white font-medium">{alert.label}</span>
                      <span className={`text-sm ${alert.urgent ? 'text-red-400' : 'text-slate-400'}`}>{alert.days}</span>
                    </div>
                  </div>
                ))}
              </div>

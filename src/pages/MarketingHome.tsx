          ...
          <div className="grid md:grid-cols-4 gap-8">
              ...
              <a href="/" className="flex flex-col items-start gap-2 mb-4">
                ...
                <div className="relative w-12 h-12">
                  ...
                  <div className="absolute inset-0 border-2 border-transparent rounded-full" style={{
                    background: 'linear-gradient(90deg, transparent 0%, transparent 40%, cyan 45%, cyan 55%, transparent 60%, transparent 100%)',
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-400 text-sm">
                ...
                <li><a href="/docs" className="hover:text-cyan-400 transition-colors">Integrations</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-400 text-sm">
                ...
                <li><a href="#compliance" className="hover:text-cyan-400 transition-colors">HIPAA Compliance</a></li>
                <li><a href="#compliance" className="hover:text-cyan-400 transition-colors">GDPR</a></li>
              </ul>
            </div>
          </div>

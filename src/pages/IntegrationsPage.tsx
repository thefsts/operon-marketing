...
const integrations = {
  ...
  payments: {
    ...
    items: [
      ...
      { name: 'Afterpay', icon: CreditCard, status: 'Native', description: 'Buy now, pay later options' },
      { name: 'Zip', icon: CreditCard, status: 'Native', description: 'Flexible payment plans' },
    ]
  },
  automation: {
    title: 'Automation',

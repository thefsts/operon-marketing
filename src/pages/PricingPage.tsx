...
export default function PricingPage() {
  const [selectedFamilyId, setSelectedFamilyId] = useState(pricingFamilies[0]?.id ?? '');
  const selectedFamily = useMemo(
    () => pricingFamilies.find((family) => family.id === selectedFamilyId) ?? pricingFamilies[0],
    [selectedFamilyId],
  );

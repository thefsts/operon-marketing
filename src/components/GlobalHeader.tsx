...
const solutions = [
  ...
  { name: 'Geofence Business Edition', path: '/geofence', desc: 'A geofence marketing business system for marketers and agencies selling managed campaigns' },
];
